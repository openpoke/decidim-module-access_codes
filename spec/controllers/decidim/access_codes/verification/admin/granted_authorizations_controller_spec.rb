...
module Decidim::AccessCodes::Verification::Admin
  describe GrantedAuthorizationsController, type: :controller do
    ...
    routes { Decidim::AccessCodes::Verification::AdminEngine.routes }
    ...
    describe "GET index" do
      ...
      it "renders a list of granted authorizations" do
        ...
        expect(subject).to render_template("decidim/access_codes/verification/admin/granted_authorizations/index")
      end
    ...
    describe "GET new" do
      context "when the handler is valid" do
        it "renders the new template" do
          ...
          expect(subject).to render_template("decidim/access_codes/verification/admin/granted_authorizations/new")
        end
      end
